...
<body>
<div class="container">    
    <form class="form-horizontal p-5 shadow" style="background-color:aqua;" method="GET" action="tablesis.php">
      ...
      <!------------>
        <div class="text-center">
          ...
          <input class="btn btn-danger" type="submit" value="batal" name="proses___">
        </div>
    </form>
  </div>
