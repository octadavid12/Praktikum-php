...
<body>
        ...
        <div class="container-fluid bg-light p-5  shadow-sm">
            <div class="row">
              <div class="col-8">
                <form method="POST" action="formbelanja.php" class="form-horizontal ">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                      <input type="text" class="form-control" name="nama__customer">
                    </div>
                  </div>
                <!------------------------>
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-8">
                        ...
                        <div class="form-check">
                          <input class="form-check-input" type="radio" id="TVz" name="produk__" value="TV">
                        ...
                        <!--------------------------->
                        <div class="form-check">
                          <input class="form-check-input" type="radio" id="Kulkaz" name="produk__" value="Kulkas">
                        ...
                        <!--------------------------->
                        <div class="form-check">
                          <input class="form-check-input" type="radio" id="MesinCuci" name="produk__" value="Mesin Cuci">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-5">
                      <input type="number" for="produk__" class="form-control" name="jumlah__" value="">
                    </div>
                  </div>

                  <button href="" type="submit" class="btn btn-primary pl-5 pr-5" name="proses__">Kirim</button>
                </form>
              </div> <!-----col-6-->
              <div class="col-4 " >
        ...
        <div class="container-fluid bg-light mt-5 mb-5 p-5 shadow-sm">
          ...
          <?php
            ...
            $proses= $_POST['proses__']; 
            $nama_customer = $_POST['nama__customer'];
            $produk = $_POST['produk__'];
            $jumlah = $_POST['jumlah__'];
